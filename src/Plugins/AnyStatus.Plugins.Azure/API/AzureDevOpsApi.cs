...
internal class AzureDevOpsApi
{
    ...
    private async Task<T> ExecuteAsync<T>(IRestRequest request, CancellationToken cancellationToken)
        where T : new()
    {
        ...
        {
            throw new ("An error occurred while requesting data from Azure DevOps. " + response.StatusDescription, response.ErrorException);
        }
    ...
    private async Task ExecuteAsync(IRestRequest request, CancellationToken cancellationToken)
    {
        ...
        if (!response.IsSuccessful || response.ErrorException != null)
        {
            throw new ($"An error occurred while sending request to Azure DevOps. {response.StatusDescription}.", response.ErrorException);
        }
    }
    ...
    internal Task<CollectionResponse<Build>> GetBuildsAsync(string            organization
                                                          , string            project
                                                          , string            definitionId
                                                          , int               top
                                                          , CancellationToken cancellationToken = default)
    {
        var request = new RestRequest(string.Format("{0}/{1}/_apis/build/builds"
    ...
    internal Task<CollectionResponse<BuildDefinition>> GetBuildDefinitionsAsync(string            organization
                                                                              , string            project
                                                                              , CancellationToken cancellationToken = default)
    {
        var request = new RestRequest(string.Format("{0}/{1}/_apis/build/definitions"
                                                  , Uri.EscapeDataString(organization)
                                                  , Uri.EscapeDataString(project)));
    ...
    internal Task QueueBuildAsync(string            organization
                                , string            project
                                , string            definitionId
                                , CancellationToken cancellationToken = default)
    {
    ...
    internal Task CancelBuildAsync(string            organization
                                 , string            project
                                 , string            buildId
                                 , CancellationToken cancellationToken)
    {
        var request = new RestRequest(string.Format("{0}/{1}/_apis/build/builds/{2}"
                                                  , Uri.EscapeDataString(organization)
                                                  , Uri.EscapeDataString(project)
    ...
    internal Task<CollectionResponse<ReleaseDefinition>> GetReleaseDefinitionsAsync(string            organization
                                                                                  , string            project
                                                                                  , CancellationToken cancellationToken = default)
    {
        var request = new RestRequest(string.Format("{0}/{1}/{2}/_apis/release/definitions"
                                                  , _endpoint.ReleaseManagement
                                                  , Uri.EscapeDataString(organization)
                                                  , Uri.EscapeDataString(project)));
    ...
    internal Task<CollectionResponse<Release>> GetReleasesAsync(string            organization
                                                              , string            project
                                                              , int               definitionId
                                                              , int               top
                                                              , CancellationToken cancellationToken = default)
    {
        var request = new RestRequest(string.Format("{0}/{1}/{2}/_apis/release/releases"
                                                  , _endpoint.ReleaseManagement
                                                  , Uri.EscapeDataString(organization)
                                                  , Uri.EscapeDataString(project)));
    ...
    internal Task CreateReleaseAsync(string            project
                                   , int               definitionId
                                   , CancellationToken cancellationToken)
    {
    ...
    internal Task<CollectionResponse<Deployment>> GetDeploymentsAsync(string            project
                                                                    , int               definitionId
                                                                    , int               top
                                                                    , CancellationToken cancellationToken = default)
    {
    ...
    internal Task DeployAsync(string            project
                            , int               releaseId
                            , int               deploymentId
                            , CancellationToken cancellationToken = default)
    {
    ...
    internal Task CancelDeploymentAsync(string            project
                                      , int               releaseId
                                      , int               deploymentId
                                      , CancellationToken cancellationToken = default)
    {
    ...
    internal Task<WorkItemQueryResult> QueryWorkItemsAsync(string            organization
                                                         , string            project
                                                         , string            query
                                                         , CancellationToken cancellationToken = default)
    {
        var request = new RestRequest(string.Format("{0}/{1}/_apis/wit/wiql?api-version=5.0"
                                                  , Uri.EscapeDataString(organization)
                                                  , Uri.EscapeDataString(project))
                                    , Method.POST);
    ...
    internal Task<CollectionResponse<WorkItem>> GetWorkItemsAsync(string            organization
                                                                , string            project
                                                                , List<string>      ids
                                                                , CancellationToken cancellationToken = default)
    {
        var request = new RestRequest(string.Format("{0}/{1}/_apis/wit/workitemsbatch?api-version=5.0"
                                                  , Uri.EscapeDataString(organization)
                                                  , Uri.EscapeDataString(project))
                                    , Method.POST);
    ...
    internal Task<CollectionResponse<WorkItemQuery>> GetWorkItemQueriesAsync(string            project
                                                                           , string            filter
                                                                           , int               top
                                                                           , CancellationToken cancellationToken = default)
    {
    ...
    internal Task<CollectionResponse<GitRepository>> GetRepositoriesAsync(string            organization
                                                                        , string            project
                                                                        , CancellationToken cancellationToken = default)
    {
        var request = new RestRequest(string.Format("{0}/{1}/{2}/_apis/git/repositories"
                                                  , _endpoint.Address
                                                  , Uri.EscapeDataString(organization)
                                                  , Uri.EscapeDataString(project)));
    ...
    internal Task<GitRepository> GetRepositoryAsync(string            organization
                                                  , string            project
                                                  , string            name
                                                  , CancellationToken cancellationToken = default)
    {
        var request = new RestRequest(string.Format("{0}/{1}/{2}/_apis/git/repositories/{3}"
                                                  , _endpoint.Address
                                                  , Uri.EscapeDataString(organization)
                                                  , Uri.EscapeDataString(project)
    ...
    internal Task<CollectionResponse<GitPullRequest>> GetPullRequestsAsync(string            organization
                                                                         , string            project
                                                                         , string            status            = "active"
                                                                         , CancellationToken cancellationToken = default)
    {
        var request = new RestRequest(string.Format("{0}/{1}/{2}/_apis/git/pullrequests"
                                                  , _endpoint.Address
                                                  , Uri.EscapeDataString(organization)
                                                  , Uri.EscapeDataString(project)));
    ...
    //Iterations
    internal Task<CollectionResponse<Iteration>> GetIterationsAsync(string            organization
                                                                  , string            project
                                                                  , CancellationToken cancellationToken = default)
    {
        var request = new RestRequest(string.Format("{0}/{1}/{2}/_apis/work/teamsettings/iterations"
                                                  , _endpoint.ReleaseManagement
                                                  , Uri.EscapeDataString(organization)
                                                  , Uri.EscapeDataString(project)));
