...
internal class AzureApi
{
    ...
    private Task<T> ExecuteAsync<T>(string resource, CancellationToken cancellationToken)
        where T : new() => ExecuteAsync<T>(new RestRequest(resource), cancellationToken);
