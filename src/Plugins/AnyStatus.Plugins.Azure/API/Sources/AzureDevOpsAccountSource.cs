...
internal class AzureDevOpsAccountSource : IAsyncItemsSource
{
    ...
    public AzureDevOpsAccountSource(IEndpointProvider endpointProvider)
    {
        _endpointProvider = endpointProvider;
    }

    public Task<IEnumerable<NameValueItem>> GetItemsAsync(object src) => src is IAzureDevOpsWidget widget
                                                                             ? GetItemsAsync(widget)
                                                                             : null;
