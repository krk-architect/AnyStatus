...
public class AzureResourcesWidget
    : StatusWidget
    , ICommonWidget
    , IPollable
    , IRequireEndpoint<AzureOAuthEndpoint>
{
    public AzureResourcesWidget() { IsAggregate = true; }

    [Required]
    [DisplayName("Subscription")]
    [AsyncItemsSource(typeof(AzureSubscriptionSource), true)]
