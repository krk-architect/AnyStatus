...
public class AppTests : IClassFixture<AppFixture>
{
    ...
    [Fact, Priority(1)]
    public void RefreshAllTest() => Click("RefreshAllButton");

    [Fact, Priority(2)]
    public void ExpandAllAllTest() => Click("ExpandAllButton");

    [Fact, Priority(3)]
    public void CollapseAllAllTest() => Click("CollapseAllButton");
    ...
    [Fact, Priority(5)]
    public void AddFolderTest() => Click("AddFolderButton");

    [Fact, Priority(6)]
    public void ShowActivityTest() => Click("ShowActivityButton");
