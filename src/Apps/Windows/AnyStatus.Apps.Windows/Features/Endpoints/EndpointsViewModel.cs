...
internal class EndpointsViewModel : BaseViewModel
{
    ...
    private void ConfigureCommands()
    {
        ...
        Commands.Add("Add",    new Command(_ => _mediator.Send(new AddEndpoint.Request
                                                               {
                                                                   Type = SelectedEndpointTypeDescription.Type
                                                               })
                                         , _ => SelectedEndpointTypeDescription is not null));
    }
}