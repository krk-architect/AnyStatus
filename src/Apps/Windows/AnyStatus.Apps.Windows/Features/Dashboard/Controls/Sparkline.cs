...
public class Sparkline : UserControl
{
    ...
    private void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            _plot.Plot.SetAxisLimits(0, Size, MinValue, MaxValue);
        }
        else
        {
            _autoAxis = true;
    ...
    private void Render()
    {
        ...
        for (var i = Values.Count; i > 0 && Values.Count - i < Size; i--)
        {
    ...
    public static readonly DependencyProperty ValuesProperty =
        DependencyProperty.Register(nameof(Values), typeof(ObservableCollection<double>), typeof(Sparkline), new FrameworkPropertyMetadata(default(ObservableCollection<double>), OnPropertyChangedCallback));
