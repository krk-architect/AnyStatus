...
public class MetricQueryRequestExceptionHandler<T> : RequestExceptionHandler<MetricRequest<T>, Unit>
    where T : class, IMetricWidget
{
    ...
    protected override void Handle(MetricRequest<T>                   request
                                 , Exception                          exception
